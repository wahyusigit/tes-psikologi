    ...
    <div class="col-md-12">
      <div class="box box-info">
        ...
        <div class="box-body">   
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <img src="{{ asset($admin->avatar) }}" class="img img-responsive" alt="User Image">
            ...
            <div class="col-md-9">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Alamat</label>
                    <textarea name="alamat" rows="3" class="form-control">{{ $admin->alamat }}</textarea>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="box-footer">
          <div class="form-group">
            <a href="{{ route('adminIndex') }}" class="btn btn-danger btn-flat pull-left"><i class="fa fa-arrow-left"></i>  Kembali</a>
          </div>
          <div class="form-group">
