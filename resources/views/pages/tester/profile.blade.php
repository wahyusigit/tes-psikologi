...
@section('main-content')
	<div class="row">
    <form action="{{ route('postTesterProfile') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="col-md-12">
      <div class="box box-info">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control" value="{{ $tester->nama }}">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label>No. Telp</label>
                    <input type="text" name="no_telp" class="form-control" value="{{ $tester->no_telp }}">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Alamat</label>
                    <textarea name="alamat" rows="3" class="form-control">{{ $tester->alamat }}</textarea>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="box-footer">
          <div class="form-group">
            <a href="{{ route('testerIndex') }}" class="btn btn-danger btn-flat pull-left"><i class="fa fa-arrow-left"></i>  Kembali</a>
          </div>
          <div class="form-group">
